...
import ListaJornadas from './ListaDeJornadas/ListaJornadasAnteriores';
import { EventAvailable, FormatListBulleted, PieChart } from '@mui/icons-material';
	...
	return (
		<>
			...
			<BarandiBottomNavigation
				tabs={['Última jornada', 'estadisticas generales', 'lista de jornadas']}
				icons={[<EventAvailable />, <PieChart />, <FormatListBulleted />]}
				value={tab}
				onchange={setTab}
			/>
		</>
